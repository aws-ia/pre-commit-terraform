...
## Note, this fork is temporary, pending approval of [this PR](https://github.com/antonbabenko/pre-commit-terraform/pull/347) and [this PR](https://github.com/antonbabenko/pre-commit-terraform/pull/352).
